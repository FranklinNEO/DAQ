...
public class CodeDBHelper extends SQLiteOpenHelper {
	...
	public void insert_codestatistics(String tablename, int productID,
			int orderID, int codeNum0, int codeNum1, int codeNum2, int codeNum3) {
		ContentValues values = new ContentValues();
		values.put("productID", productID);
		values.put("orderID", orderID);
		values.put("codeNum0", codeNum0);
	...
	public void update_order(String tablename, String orderType,
		...
		mDb.update(tablename, values, "CorpOrderID='" + CorpOrderID + "';",
				null);
		values.clear();
	}
	...
	public void delete_orderCode(String tablename, int orderID) {
		mDb.delete(tablename, "orderID='" + orderID + "';", null);
	}
	...
	public void delete_codeStatistics(String tablename, int orderID) {
		mDb.delete(tablename, "orderID='" + orderID + "';", null);
	}
